...
**Cat mascot kits:** green-screen stills in [`scripts/cat_emoji/stills/`](scripts/cat_emoji/stills/) (`black/`, `white/`, `siamese/`). Generate via [`scripts/training_roles/`](scripts/training_roles/) (black Course Builder / dev), [`scripts/white_cat_emoji/`](scripts/white_cat_emoji/) (white PM emoji, keyed), [`scripts/siamese_cat_emoji/`](scripts/siamese_cat_emoji/) (Siamese tester, glasses, keyed), [`scripts/cat_office_battles/`](scripts/cat_office_battles/) (office scenes, no key). Exports live under `C:\Users\roywa\Pictures\mascots\`.
