...
export default {
  ...
  'auth.modal.mainlandSalesNotice': 'Benodig toegang in die Chinese vasteland? Gebruik jou selfoonnommer en uitnodigingskode, of kontak verkope.',
  ...
  'auth.quickRegPageHint': 'Maak hierdie bladsy oop vanaf die skakel wat jou skool gedeel het. Voer jou foon en die 6-syfer-kamerkode in wat in die fasiliteerder se vinnige registrasievenster gewys word (dit herlaai omtrent elke 30 sekondes). Die kode wys jy is in die sessie; dit verifieer nie fooneienaarskap soos \'n SMS-kode sou nie.',
  ...
  'auth.quickRegProbeRateLimited': 'Te veel tjeks vanaf hierdie bladsy. Wag \'n oomblik en verfris, of probeer later weer.',
  ...
  'auth.quickRegRoomCodeHint': 'Pas die groot syfers op die fasiliteerder se vinnige registrasiedialoog by; voer die kode in voordat dit verander.',
  ...
  'auth.quickRegSessionUnsure': 'Registrasie het dalk geslaag. As jy nie aangemeld is nie, gaan terug en gebruik SMS-aanmelding, of verfris hierdie bladsy.',
  ...
  'auth.setPasswordWithSmsHint': 'Ons stuur \'n kode na jou gebonde foon. Nadat u \'n wagwoord gestel het, kan u met \'n wagwoord of SMS aanmeld.',
