/** it UI — notification (translated from en; review recommended) */
export default {
  'notification.cannotClearTopicOrCenter': 'Impossibile svuotare i nodi tema o centrale',
  ...
  'notification.collabRedoBlocked': 'Impossibile ripetere mentre un altro utente sta modificando',
  'notification.collabUndoBlocked': 'Impossibile annullare mentre un altro utente sta modificando',
  ...
  'notification.historyClearNodes': 'Svuota testo nodo',
  ...
  'notification.selectNodeToClear': 'Seleziona un nodo da svuotare',
