...
export default {
  ...
  'notification.historyEmptyLearning': '노드를 비우고 답안 추가',
  'notification.importInvalidData': '가져오기 실패: 다이어그램 데이터가 잘못되었습니다',
  ...
  'notification.importSlotsFull':
    '라이브러리가 가득 찼습니다. 다이어그램은 가져왔지만 저장되지 않았습니다',
  ...
  'notification.newVersionAvailable': '새 버전이 있습니다. 클릭하여 새로 고침.',
