...
export default {
  ...
  'auth.dingtalkBindInstructions': '请在钉钉 MindBot 中发送此二维码图片（仅发送图片即可）。',
  'auth.dingtalkBindQrAlt': '钉钉绑定二维码',
  'auth.dingtalkBindCountdown': '二维码将在 {s} 秒后过期',
  'auth.dingtalkBindQrRefreshIn': '二维码将在 {s} 秒后刷新',
  'auth.dingtalkBindExpiredHint': '二维码已过期，请重新生成。',
