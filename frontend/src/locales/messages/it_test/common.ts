...
export default {
  ...
  'landing.international.promptPlaceholder':
    'Inserisci un argomento o una breve descrizione oppure scegli un tipo di diagramma di seguito...',
  ...
  'landing.international.mindmateCard.desc':
    "Il tuo partner virtuale per l'insegnamento e la ricerca",
  'landing.international.shareSite': 'Condividi il sito',
  'landing.international.shareSiteModalTitle': 'Condividi il sito',
  'landing.international.shareSiteModalHint': '',
  'landing.international.shareSiteCopy': 'Copia collegamento',
  'landing.international.shareSiteCopied': 'Collegamento copiato',
}
