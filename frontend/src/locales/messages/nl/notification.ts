...
export default {
  ...
  'notification.collabRedoBlocked':
    'Kan niet opnieuw uitvoeren terwijl een andere gebruiker bezig is',
  'notification.collabUndoBlocked': 'Kan niet ongedaan maken terwijl een andere gebruiker bezig is',
  ...
  'notification.geoLiteMissingIntro':
    'Download GeoLite2 Country van MaxMind, pak GeoLite2-Country.mmdb uit en kopieer het naar de servergegevensmap:',
  'notification.geoLiteMissingLink': 'Open MaxMind GeoLite-downloadpagina',
  'notification.geoLiteMissingPathLabel': 'Verwacht pad:',
  'notification.geoLiteMissingTitle': 'GeoLite2 Country-database ontbreekt',
  'notification.fullscreenFailed': 'Kon niet naar volledig scherm',
  'notification.generationCancelled': 'Generatie geannuleerd',
  'notification.historyClearNodes': 'Knoopttekst wissen',
  ...
  'notification.resetDefaultTemplate': 'Resetten naar standaardsjabloon',
  'notification.rootConceptLinkNotFound': 'Hoofdconceptkoppeling niet gevonden',
