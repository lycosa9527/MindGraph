...
export default {
  ...
  'notification.collabRedoBlocked':
    'Kan niet opnieuw uitvoeren terwijl een andere gebruiker bezig is met bewerken',
  'notification.collabUndoBlocked':
    'Kan niet ongedaan maken terwijl een andere gebruiker bezig is met bewerken',
  ...
  'notification.loadMoreFailed': 'Kan niet meer laden',
  ...
  'notification.resetDefaultTemplate': 'Terug naar standaardsjabloon',
  ...
  'notification.sessionInvalidated':
    'U bent uitgelogd omdat u het maximale aantal apparaten heeft overschreden',
