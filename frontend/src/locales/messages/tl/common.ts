/** tl UI — common (machine-translated from en; review as needed) */
export default {
  ...
  "landing.international.shareSiteModalHint": "Scan with a phone or tablet camera to open this page for your class.",
