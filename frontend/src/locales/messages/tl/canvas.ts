/** tl UI — canvas (machine-translated from en; review as needed) */
export default {
  ...
  "canvas.import.invalidFile": "Invalid diagram file. Please select a JSON file exported from MindGraph.",
