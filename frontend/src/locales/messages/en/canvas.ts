...
export default {
  ...
  'canvas.mindMapOneSentence.intro': 'Enter a topic or describe the mind map you want',
  'canvas.mindMapOneSentence.requirementsPlaceholder': 'e.g. The development and applications of AI',
  ...
  'canvas.mindMapOneSentence.example1':
    'Artificial intelligence: principles, applications, ethics, future trends',
