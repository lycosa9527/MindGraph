...
export default {
  ...
  'admin.invitationCodeAutoGenerated':
    'An XXX-XXX invitation code will be generated automatically after creation.',
  ...
  'admin.mindbot.moveNoTargets':
    'No organization can accept another bot (each school is limited to five).',
  ...
  'admin.mindbot.standaloneDifySchoolHint':
    'For most schools, set Dify on the school edit modal under MindMate auth. Saving the school copies those settings to all bots. Per-bot Dify here is only for special cases and may be overwritten when the school is saved.',
  ...
  'admin.refreshInvitationCodeConfirm':
    'The current invitation code will stop working. Generate a new one?',
  ...
  'admin.schoolMindmateAgentNameHint':
    'Shown in the sidebar and MindMate UI. Leave empty to use MindMate.',
  ...
  'admin.schoolDifyGlobalUnconfigured':
    'Global Dify is not configured in .env (DIFY_API_URL / DIFY_API_KEY).',
  ...
  'admin.schoolDifyApiKeyHintOptional':
    'Required only when setting a school-specific override. Leave both fields empty to use global .env settings.',
  ...
  'admin.schoolDifyAuthTestTooltip':
    'Test Dify auth with the URL and key in this form (unsaved edits are included).',
  ...
  'admin.schoolDifyAuthRequiredOnCreate':
    'Run Dify auth test successfully before creating the school.',
  'admin.copyShortInvite': 'Copy short link',
  'admin.schoolDifyAuthErrorNoKey':
    'API key is not configured (enter one or set global DIFY_API_KEY in .env).',
  'admin.schoolDifyAuthErrorNoUrl':
    'Base URL is not configured (enter one or set global DIFY_API_URL in .env).',
  ...
  'admin.usersTokensAllTimeHint':
    'Token counts are all-time totals. Click a name or token value to open the trend chart on All Time.',
