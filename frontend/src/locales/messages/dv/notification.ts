...
export default {
  ...
  'notification.canvasClearNodesLearning': '{count} ނޯޑް ހުސްކޮށް ޖަވާބަށް އިތުރުކޮށް',
  'notification.canvasSomeoneEditingNode': 'ވެނެ އެހެން މީހަކު މި ނޯޑް އެޑިޓް ކުރޭ',
  ...
  'notification.deleteFailed': 'ޑިލީޓް ކުރުމް ފޭލް ވީ',
  'notification.deleted': 'އައިޓަމް ކާމިޔާބު ގޮތަކަށް ޑިލީޓް ކުރެވޭނެ',
  'notification.feedbackCancelled': 'ފީޑްބެކް ނައިކޮށް',
  'notification.feedbackThanks': 'ފީޑްބެކަށް ޝުކުރިއްޔާ',
  'notification.feedbackThanksDislike': 'ފީޑްބެކަށް ޝުކުރިއްޔާ — ބަދަލު ކުރާނެން',
  'notification.focusQuestionTooShort': 'ފުރަތަމަ ދަހަވީ ފޯކަސް ސުވާލު ލިޔޭ',
  'notification.fullscreenFailed': 'ފުރަތަމަ ސްކްރީން ގައި ވަދެވޭނެ ގޮތެއް ނުވާނެ',
  'notification.generationCancelled': 'ޖެނޭރޭޝަން ކެންސަލް ކުރެވޭނެ',
  'notification.historyClearNodes': 'ނޯޑް ޓެކްސް ސާފު ކޮށް',
  ...
  'notification.importUnsupportedType': 'އިމްޕޯޓް ފޭލް: ޑައިގްރާމް ޓައިޕް ސަޕޯޓް ނުވާނެ',
  'notification.loadMoreFailed': 'އިތުރު ލޯޑް ކުރެވޭނެ ގޮތެއް ނުވާނެ',
  'notification.networkError': 'ނެޓްވޯކް އެރަރ',
  'notification.newVersionAvailable': 'އައު ވާޝަން އެބަދައި އޮތް. ރިފްރެޝް ކުރަން ކްލިކް ކޮށް.',
  'notification.recommendationFailed': 'ރެކޮމެންޑޭޝަން ފޭލް: {msg}',
  'notification.relationshipGenerationFailed': 'ރިލޭޝަންޝިޕް ޖެނޭރޭޝަން ފޭލް',
  'notification.resetDefaultTemplate': 'ޑީފޯލްޓް ޓެމްޕްލޭޓަށް ރީސެޓް ކޮށް',
