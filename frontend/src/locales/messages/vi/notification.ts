...
export default {
  ...
  'notification.collabDeleteBlocked': 'Không thể xóa khi người dùng khác đang chỉnh sửa nút đã chọn',
  ...
  'notification.conceptMapTabNeedsAi': 'Hãy bật AI trên thanh công cụ trước khi dùng gợi ý Tab.',
  ...
  'notification.importLoadFailed': 'Nhập thất bại: không thể tải sơ đồ',
  ...
  'notification.inlineRecEmpty': 'Không có gợi ý nào được tạo. Thử lại hoặc chỉnh sửa chủ đề.',
  'notification.loadMoreFailed': 'Không thể tải thêm',
  'notification.networkError': 'Lỗi mạng',
  'notification.nodeNotEligible': 'Nút này không hỗ trợ gợi ý Tab.',
  'notification.newVersionAvailable': 'Có phiên bản mới. Nhấn để làm mới.',
  ...
  'notification.selectNodeToClear': 'Hãy chọn nút để xóa',
  'notification.sessionInvalidated': 'Bạn đã bị đăng xuất vì vượt quá số thiết bị tối đa',
  'notification.sessionKicked': 'Tài khoản này đã đăng nhập tài khoản này ngoại tuyến trên các thiết bị khác',
  'notification.signInToUse': 'Đăng nhập để sử dụng',
  'notification.signInToValidateFocus': 'Đăng nhập để xác minh câu hỏi trọng tâm',
} as const
