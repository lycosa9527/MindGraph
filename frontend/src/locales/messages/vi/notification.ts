...
export default {
  ...
  'notification.canvasClearNodesLearning': 'Đã làm trống {count} nút, đã thêm vào phần đáp án',
  'notification.canvasSomeoneEditingNode': 'Người khác đang chỉnh sửa nút này',
  'notification.collabDeleteBlocked':
    'Không thể xóa khi người dùng khác đang chỉnh sửa một nút đã chọn',
  ...
  'notification.focusQuestionTooShort': 'Vui lòng nhập câu hỏi trọng tâm dài hơn trước',
  'notification.fullscreenFailed': 'Không thể vào chế độ toàn màn hình',
