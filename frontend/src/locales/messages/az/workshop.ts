...
export default {
  ...
  'workshop.archiveAnnounceChannel': 'Arxiv Elan Kanalı',
  'workshop.archiveAnnounceChannelConfirm': 'Bu elan kanalını arxivləşdirmək istədiyinizə əminsiniz? Yan panel artıq göstərilməyəcək, lakin mesaj qalacaq.',
  'workshop.deleteTeachingGroup': 'Tədris və tədqiqat qrupunu silin',
  'workshop.deleteTeachingGroupConfirm': 'Bu tədris və tədqiqat qrupunu, onun dərslərini və mesajlarını həmişəlik silmək istədiyinizə əminsiniz? Bu əməliyyat geri qaytarıla bilməz.',
  'workshop.deleteAnnounceChannel': 'Elan kanalını silin',
  'workshop.deleteAnnounceChannelConfirm': 'Bu elan kanalını və onun mesajlarını həmişəlik silmək istədiyinizə əminsiniz? Bu əməliyyat geri qaytarıla bilməz.',
  'workshop.deleteLessonStudy': 'Dərsi silin',
  'workshop.deleteLessonStudyConfirm': 'Bu dərsi və onun mesajlarını həmişəlik silmək istədiyinizə əminsiniz? Bu əməliyyat geri qaytarıla bilməz.',
  'workshop.manageNeedAdmin': 'Yalnız məktəb administratorları tədris və tədqiqat qrupları əlavə edə bilər. İdarəçilər və ya qrupun yaradıcısı silə bilər.',
  ...
  'workshop.channelDeleteFailed': 'Kanalı silmək mümkün deyil',
  ...
  'workshop.deleteMessageConfirm': 'Bu mesaj silinsin?',
  ...
  'workshop.editMessage': 'redaktə et',
  'workshop.editMessageFailed': 'Redaktə edilmiş mesajı saxlamaq mümkün deyil',
  'workshop.editMessagePrompt': 'Mesajı redaktə edin',
  ...
  'workshop.bulletedList': 'sıralanmamış siyahı',
  'workshop.diagramInsertFailed': 'İkonu daxil etmək alınmadı',
  'workshop.diagramInserting': 'Nişan daxil edilir...',
  'workshop.diagramPickerEmpty': 'Şəkil kitabxanası boşdur, lütfən, əvvəlcə şəkili kətanda yadda saxlayın.',
  'workshop.diagramPickerTitle': 'İkon kitabxanamdan seçin',
  'workshop.exitPreview': 'Önizləmədən çıxın',
  'workshop.math': 'düstur',
  'workshop.numberedList': 'sifariş siyahısı',
  'workshop.preview': 'Önizləmə',
  'workshop.previewEmpty': 'Önizləmək üçün məzmun yoxdur',
  'workshop.quote': 'Sitat',
  'workshop.spoiler': 'Məzmunu yığcamlaşdırın',
  'workshop.table': 'vərəq',
  'workshop.you': '(siz)',
