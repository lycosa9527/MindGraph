...
export default {
    ...
    "collab.hintSchoolInactive": "Aktivləşdikdən sonra eyni məktəb həmkarları əsas səhifədən qoşula bilər.",
    ...
    "collab.schoolDescActive": "Məktəb əməkdaşlığı aktivdir. Həmkarlar: əsas səhifədə Əməkdaşlıq → Məktəb və bu diaqramı seçin — kod lazım deyil.",
    "collab.schoolStarted": "Məktəb əməkdaşlığı aktivdir — həmkarlar Əməkdaşlıq → Məktəb-dən qoşula bilər.",
    ...
    "collab.shareDescNetwork": "Kodu və ya linki paylaşın — digərləri Əməkdaşlıq → Ümumi altında daxil edə bilər.",
    "collab.start": "Başlat",
