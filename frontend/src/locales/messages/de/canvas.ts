...
export default {
  ...
  'canvas.mindMapNodeExplain.userPrompt': 'Warum könnte „{node}“ Fragen oder kognitiven Konflikt in diesem Diagramm auslösen?',
  'canvas.mindMapNodeExplain.thinking': 'Ihr Diagramm wird betrachtet …',
  'canvas.mindMapNodeExplain.inputPlaceholder': 'Nachfrage stellen oder Gedanken teilen …',
  'canvas.mindMapNodeExplain.sendButton': 'Senden',
  'canvas.mindMapNodeExplain.close': 'Verstanden',
  'canvas.mindMapNodeExplain.requestFailed': 'Keine Erklärung erhalten. Bitte versuchen Sie es erneut.',
