...
export default {
  ...
  'notification.cannotResetSelectDiagramType': 'Impossible de réinitialiser : veuillez d\'abord sélectionner un type de diagramme',
  ...
  'notification.collabDeleteBlocked': 'Impossible de supprimer tant qu’un autre utilisateur modifie un nœud sélectionné',
  'notification.collabRedoBlocked': 'Impossible de rétablir tant qu’un autre utilisateur modifie le diagramme',
  'notification.collabUndoBlocked': 'Impossible d’annuler tant qu’un autre utilisateur modifie le diagramme',
  ...
  'notification.geoLiteMissingIntro': 'Téléchargez GeoLite2 Country depuis MaxMind, extrayez GeoLite2-Country.mmdb et copiez-le dans le dossier de données du serveur :',
