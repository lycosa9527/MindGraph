export default {
  ...
  'auth.updateLogLoadError': 'Impossible de charger les notes de version. Veuillez réessayer plus tard.',
  ...
  'auth.modal.mainlandSalesNotice': 'Besoin d’un accès en Chine continentale ? Utilisez votre numéro de mobile et le code d’invitation, ou contactez les ventes.',
  ...
  'auth.quickRegPageHint': 'Ouvrez cette page depuis le lien partagé par votre établissement. Saisissez votre téléphone et le code salle à 6 chiffres affiché dans la fenêtre d’inscription rapide de l’animateur (il se renouvelle environ toutes les 30 secondes). Ce code atteste votre présence à la session ; il ne vérifie pas la possession du téléphone comme un code SMS.',
  'auth.quickRegLinkInvalid': 'Ce lien d’inscription n’est pas actif (expiré ou fermé). Rouvrez le lien à jour fourni par l’animateur.',
  'auth.quickRegProbeRateLimited': 'Trop de vérifications depuis cette page. Patientez, actualisez, ou réessayez plus tard.',
  ...
  'auth.quickRegRoomCodeHint': 'Reproduisez les grands chiffres du dialogue d’inscription rapide de l’animateur ; saisissez le code avant qu’il change.',
  ...
  'auth.quickRegSessionUnsure': 'L’inscription a peut-être réussi. Si vous n’êtes pas connecté, revenez et utilisez la connexion par SMS, ou actualisez la page.',
  ...
  'auth.setPasswordWithSmsHint': 'Nous envoyons un code sur votre téléphone associé. Après définition du mot de passe, vous pourrez vous connecter par mot de passe ou par SMS.',
