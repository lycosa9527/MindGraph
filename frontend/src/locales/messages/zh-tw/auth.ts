...
export default {
  ...
  'auth.quickRegPageHint':
    '請使用學校分享的連結進入本頁。輸入手機號，並輸入老師快速註冊視窗上顯示的 6 位數字碼（約每 30 秒變更）後完成加入。房間碼用於確認你在場，不會像簡訊驗證碼那樣單獨驗證手機持有人。',
  'auth.quickRegLinkInvalid': '此註冊連結已失效或已關閉，請向主持人取得最新連結後再試。',
  'auth.quickRegProbeRateLimited': '本頁請求過於頻繁，請稍候再重新整理或晚點再試。',
  ...
  'auth.quickRegFacilitatorCode': '目前房間碼（請學員輸入）',
  'auth.quickRegCodeRefreshIn': '碼將在 {s} 秒後變更',
  ...
  'auth.quickRegMintError': '無法建立註冊通道，請稍後再試。',
  'auth.setPasswordWithSms': '設定登入密碼',
  'auth.setPasswordWithSmsTitle': '用簡訊設定登入密碼',
  'auth.setPasswordWithSmsHint': '向已綁定手機傳送簡訊驗證碼，設定後可使用密碼或簡訊登入。',
  'auth.setPasswordWithSmsSubmit': '設定密碼',
  'auth.setPasswordWithSmsSubmitting': '儲存中…',
  'auth.accountDisplayName': '顯示姓名',
  'auth.accountNamePlaceholder': '至少 2 個字元，不能含數字',
