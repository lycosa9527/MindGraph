...
export default {
  ...
  'auth.voiceNotes.authFailed': '語音筆記鉴權失敗，請重新登錄。',
  ...
  'auth.voiceNotes.sheetHint': '停止後儲存轉錄。準備好後再點生成思維導圖。',
  ...
  'auth.voiceNotes.status.savingTranscript': '正在儲存轉錄',
  'auth.voiceNotes.status.separatingTalkers': '正在區分說話人',
  'auth.voiceNotes.status.generating': '正在生成思維導圖',
  'auth.voiceNotes.status.ready': '轉錄已儲存，可生成思維導圖',
  'auth.voiceNotes.savedJustNow': '轉錄剛剛已儲存',
  'auth.voiceNotes.savedSecondsAgo': '轉錄已於{n}秒前儲存',
  ...
  'auth.voiceNotes.resetTalker': '恢復預設',
  'auth.voiceNotes.tencentAuth': '語音識別鑑權失敗，請檢查騰訊雲金鑰。',
  'auth.voiceNotes.tencentService': '騰訊雲語音識別未開通，請在控制台開通服務。',
  'auth.voiceNotes.tencentQuota': '騰訊雲語音識別資源包已用盡，請開通後付費或購買資源包。',
  'auth.voiceNotes.tencentArrears': '騰訊雲帳號欠費，語音識別已停用。',
  'auth.voiceNotes.tencentConcurrency': '語音識別並發已滿，請稍後重試。',
  'auth.voiceNotes.tencentAudio': '音訊無法識別，請重試。',
  'auth.voiceNotes.tencentSendRate': '音訊傳送過快，請保持即時錄音。',
  'auth.voiceNotes.tencentIdle': '錄音中斷過久，語音識別已斷開。',
  'auth.voiceNotes.tencentRetry': '語音識別暫時失敗，請重試。',
  'auth.voiceNotes.tencentRegion': '目前網路不在騰訊雲中國站服務範圍。',
  ...
  'auth.voiceNotes.messageTooLarge': '音訊資料包過大，請重試。',
  'auth.voiceNotes.invalidMessage': '語音筆記訊息無效，請重試。',
  'auth.voiceNotes.asrUnavailable': '語音識別暫不可用，請稍後再試。',
  ...
  'auth.apiTokenVisible': '目前令牌',
  'auth.apiTokenCopy': '複製',
  'auth.apiTokenCopied': '已複製',
  'auth.apiTokenCopyFailed': '複製失敗',
  'auth.apiTokenLoading': '載入中…',
  'auth.apiTokenNone': '尚未產生令牌。下載技能包或點 API令牌 即可建立。',
  'auth.apiTokenOpaque': '目前令牌無法回顯，請重新產生。',
  ...
  'auth.downloadOpenclawSkillHint': '下載即含帳號與目前令牌。重新產生令牌後，舊技能包與擴充功能會失效。',
