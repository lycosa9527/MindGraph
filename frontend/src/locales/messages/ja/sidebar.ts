...
export default {
  ...
  'sidebar.bookmarks.loginPrompt': '最近のブックマークを表示するにはログイン',
  ...
  'sidebar.diagramHistory.loginPrompt': '図を表示するにはログイン',
  'sidebar.diagramHistory.nameRequired': '名前を入力してください',
