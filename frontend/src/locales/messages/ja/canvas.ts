...
export default {
  ...
  'diagram.contextMenu.explain': '学习ヒント',
  ...
  'canvas.mindMapNodeExplain.thinking': '正在看你的マインドマップ…',
  ...
  'canvas.mindMapNodeExplain.requestFailed': 'Could not get an explanation. もう一度お試しください.',
