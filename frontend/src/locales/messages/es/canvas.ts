...
export default {
  ...
  'canvas.topBar.focusChipHint': '{label}: press Tab while editing the focus question to validate',
  'canvas.topBar.focusChipPass': 'OK',
  'canvas.topBar.focusChipSignIn':
    'Sign in, then press Tab while editing the focus question to validate',
  'canvas.topBar.focusChipValidating': '{label} validating…',
  'canvas.topBar.focusChipWeak': 'Weak',
  'canvas.topBar.focusQuestionLabel': 'Focus question:',
