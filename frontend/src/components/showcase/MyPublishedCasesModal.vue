...
function statusClass(status: ShowcasePost['status']): string {
...
async function loadPosts() {
  ...
  try {
    const res = await getShowcasePosts({ page: 1, pageSize: 100, mine: true, sort: 'newest' })
...
function resubmitPost(post: ShowcasePost) {
