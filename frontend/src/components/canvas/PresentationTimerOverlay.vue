  ...
  >
    ...
    >
      ...
      <div class="flex w-full max-w-xl shrink-0 flex-wrap justify-center gap-2">
        ...
        >
          {{ m }}<I18nText k="canvas.presentationTimer.minSuffix" />
        </ElButton>
      </div>
      ...
      <div class="flex w-full max-w-xl shrink-0 flex-wrap items-center justify-center gap-2">
        <label class="flex items-center gap-2 text-sm text-white/90">
          <span><I18nText k="canvas.presentationTimer.customMinutes" /></span>
          <input
        ...
        >
          <I18nText k="canvas.presentationTimer.set" />
        </ElButton>
      </div>
      ...
      <div class="flex w-full max-w-2xl shrink-0 flex-wrap items-center justify-center gap-3">
        ...
        >
          ...
          <I18nText k="canvas.presentationTimer.startPresenting" />
        </ElButton>
        <ElButton
          native-type="button"
          size="large"
        ...
        >
          ...
          <I18nText k="canvas.presentationTimer.reset" />
        </ElButton>
        <ElButton
          native-type="button"
          size="large"
        ...
        >
          ...
          <I18nText k="canvas.presentationTimer.exitTimer" />
        </ElButton>
      </div>
