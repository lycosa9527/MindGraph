...
<template>
  <ElButton
    class="contacts-toggle-btn shrink-0"
    :class="{ 'is-active': open }"
    size="small"
    :title="t('mindmate.collabToggleContactsTitle')"
    :aria-expanded="open"
    @click="emit('toggle')"
  >
    <Users class="w-3.5 h-3.5 mr-1" />
    {{ t('mindmate.collabToggleContacts') }}
  </ElButton>
</template>

<style scoped>
.contacts-toggle-btn {
  --el-button-bg-color: #fafaf9;
