...
const ROWS: RowDef[] = [
  ...
  {
    apiKey: 'feature_student_learning_space',
    envKey: 'FEATURE_STUDENT_LEARNING_SPACE',
    labelKey: 'admin.feature.studentLearningSpace',
    hintKey: 'admin.feature.studentLearningSpaceHint',
  },
  {
