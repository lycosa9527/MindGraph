...
const DIAGRAM_TYPE_LABELS: Record<string, { zh: string; en: string; az: string }> = {
...
function pickLocale(labels: { zh: string; en: string; az: string }, locale: LocaleCode): string {
