...
CONCEPT_30_EN = """Generate exactly 30 specific and meaningful concepts related to: {central_topic}
...
- "create a bubble map about double bubble maps" → user wants bubble_map, topic is about double bubble maps → bubble_map
- "create a mind map about concept maps" → user wants mind_map, topic is about concept maps → mind_map
- "create a concept map about mind maps" → user wants concept_map, topic is about mind maps → concept_map
- "create a double bubble map comparing apples and oranges" → user wants double_bubble_map → double_bubble_map

User input: "{user_prompt}"

Key phrases to identify:
- "create a bubble map about..." / "generate a bubble map about..." → bubble_map
- "create a double bubble map..." / "generate a double bubble map..." → double_bubble_map
- "create a mind map about..." / "generate a mind map about..." → mind_map
- "create a concept map about..." / "generate a concept map about..." → concept_map
- "create a flow map..." / "generate a flow map..." → flow_map
- "create a tree map..." / "generate a tree map..." → tree_map
- Focus on what diagram type the user is requesting (after "create/generate"), not the topic content (after "about")

Available diagram types and their use cases:
1. bubble_map - describing attributes, characteristics, features
2. bridge_map - analogies, comparing similarities between concepts
3. tree_map - classification, hierarchy, organizational structure
4. circle_map - defining concepts in context, environment
5. double_bubble_map - comparing and contrasting two things
6. multi_flow_map - cause-effect relationships, multiple causes and effects
7. flow_map - step sequences, process flows
8. brace_map - whole-to-part relationships
9. concept_map - relationship networks between concepts
10. mind_map - brainstorming, divergent thinking
