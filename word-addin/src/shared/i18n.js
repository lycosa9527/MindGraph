...
var MG_I18N = {
  zh: {
    ...
    settingsStatusSaved: '已保存登录信息（未校验）',
    settingsStatusVerified: '已验证：打开 MindGraph / MindMate / 案例广场时将自动登录',
    settingsStatusInvalid: '令牌或手机号无效，请检查后重试（不会自动登录）',
    settingsStatusNetwork: '无法连接服务器，请检查地址后重试',
    settingsVerifying: '正在验证登录信息…',
    settingsSavedToast: '已保存',
    settingsVerifiedToast: '已验证，可免登录打开',
    settingsClearedToast: '已清除令牌',
    langZh: '中文',
    langEn: 'English',
    handoffFailed: '自动登录失败。请回到「设置」检查令牌，或手动以访客打开。',
  },
  en: {
    btnMindMate: 'MindMate',
    btnMindGraph: 'MindGraph',
    ...
    settingsStatusSaved: 'Credentials saved (not verified yet)',
    settingsStatusVerified: 'Verified — MindGraph / MindMate / Showcase open login-free',
    settingsStatusInvalid: 'Phone or token rejected — fix and save again (no auto sign-in)',
    settingsStatusNetwork: 'Cannot reach server — check the URL and try again',
    settingsVerifying: 'Verifying credentials…',
    settingsSavedToast: 'Saved',
    settingsVerifiedToast: 'Verified — login-free ready',
    settingsClearedToast: 'Token cleared',
    langZh: '中文',
    langEn: 'English',
    handoffFailed: 'Auto sign-in failed. Check the token in Settings, or open as guest.',
  },
}
