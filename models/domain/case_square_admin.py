"""
Case Square admin models — staff grants, field options, audit log.
"""
...
class CaseSquareStaffGrant(Base):
    """Per-user Case Square permissions (reviewers, proxy publishers, etc.)."""
...
class CaseSquareFieldOption(Base):
...
class CaseSquareAuditLog(Base):
    """Audit trail for Case Square moderation actions."""
