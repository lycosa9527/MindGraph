"""
Showcase models — moderated public teaching case gallery.
...
def generate_case_uuid() -> str:
    """Generate a UUID string for showcase post IDs."""
    return str(uuid.uuid4())


class ShowcasePost(Base):
    """Public teaching case in the Showcase gallery."""
...
class ShowcasePostLike(Base):
    """User likes on showcase posts."""
...
class ShowcasePostFavorite(Base):
    """User favorites (bookmarks) on showcase posts."""
