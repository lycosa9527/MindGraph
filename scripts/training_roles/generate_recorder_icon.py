...
PROMPT = (
    ...
    "tiny pink nose, red gingham bandana, mouth wide open mid-meow as if "
    "singing into a mic. Same face as the reference, not a new cat. Soft peach "
    "background. No body, no recorder, no microphone, no props, no text, no "
    "watermark. Cute 3D toy emoji, thick simple shapes, high contrast, small "
    "margin."
)
...
def main() -> None:
    ...
    raw = WORK_DIR / "recorder-watch-icon.png"
