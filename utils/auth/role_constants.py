...
PLATFORM_LEVEL_ROLES: frozenset[str] = frozenset({ROLE_SUPERADMIN, ROLE_PLATFORM_BD, ROLE_EXPERT})
...
_CAPABILITY_ROLE_MAP: dict[str, frozenset[str]] = {
    ...
    CAPABILITY_ORG_CREATE_AND_ASSIGN: frozenset({ROLE_SUPERADMIN, ROLE_EXPERT}),
    ...
    CAPABILITY_PERSONAL_TRIAL_INVITE: frozenset({ROLE_SUPERADMIN, ROLE_PLATFORM_BD, ROLE_EXPERT}),
