    ...
    def on_event(self, response: dict) -> None:
        ...
        try:
            ...
            # Input Audio Buffer Events (VAD)
                ...
                logger.info(f"Speech started at {audio_start_ms}ms (item: {item_id})")
                ...
                item_id = response.get('item_id', '')
                logger.info(f"Speech stopped at {audio_end_ms}ms (item: {item_id})")
            ...
            # Conversation Item Events
                ...
                item_id = response.get('item_id', '')
                logger.info(f"Transcription: '{transcript}' (item: {item_id})")
