...
def test_extract_bind_token_from_url() -> None:
    """Bind token is parsed from a MindGraph bind URL query string."""
    token = "abc123XYZ"
...
def test_extract_bind_payload_includes_rotating_code() -> None:
    """Bind payload includes both token and rotating room code."""
    token = "abc123XYZ"
    code = "042816"
