...
from services.kitty.kitty_redis_keys import kitty_mobile_active_key, kitty_redis_ttl_seconds
...
async def _emit_desktop_wake(user_id: int, mobile_state: Dict[str, Any]) -> None:
    from services.kitty.kitty_desktop_wake_fanout import publish_kitty_desktop_wake
