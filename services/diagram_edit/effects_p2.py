...
from services.diagram_edit.types import MINDMAP_DIAGRAM_TYPES, THINKING_MAP_DIAGRAM_TYPES

P2_DIAGRAM_TYPES: FrozenSet[str] = THINKING_MAP_DIAGRAM_TYPES | frozenset({"concept_map"})
