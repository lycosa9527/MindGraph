"""
Canvas collaboration WebSocket disconnect cleanup (leaf module, no router imports).
...
from services.features.workshop_ws_collab_disconnect_api import (
    register_finalize_canvas_collab_disconnect,
)
from services.features.workshop_ws_broadcast_core import broadcast_to_all, broadcast_to_others
from services.features.workshop_ws_connection_state import AnyHandle, unregister_connection
...
register_finalize_canvas_collab_disconnect(finalize_canvas_collab_disconnect)
