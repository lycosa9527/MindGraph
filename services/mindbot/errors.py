...
class MindbotErrorCode(str, Enum):
    ...
    ADMIN_MOVE_SAME_ORGAN = "MINDBOT_ADMIN_MOVE_SAME_ORGAN"
    ...
    BIND_OK = "MINDBOT_BIND_OK"
    BIND_TOKEN_EXPIRED = "MINDBOT_BIND_TOKEN_EXPIRED"
    BIND_TOKEN_CONSUMED = "MINDBOT_BIND_TOKEN_CONSUMED"
    BIND_ORG_MISMATCH = "MINDBOT_BIND_ORG_MISMATCH"
    BIND_STAFF_TAKEN = "MINDBOT_BIND_STAFF_TAKEN"
    BIND_IMAGE_UNREADABLE = "MINDBOT_BIND_IMAGE_UNREADABLE"
    BIND_UNAVAILABLE = "MINDBOT_BIND_UNAVAILABLE"
    BIND_INVALID_STAFF = "MINDBOT_BIND_INVALID_STAFF"
    BIND_INTERNAL = "MINDBOT_BIND_INTERNAL"
    UNBIND_OK = "MINDBOT_UNBIND_OK"
    UNBIND_NOT_LINKED = "MINDBOT_UNBIND_NOT_LINKED"
    UNBIND_STAFF_MISMATCH = "MINDBOT_UNBIND_STAFF_MISMATCH"
