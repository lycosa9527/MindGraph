...
class DiagramSelector {
    ...
    transitionToEditor(diagramType, template, diagramName) {
        ...
        try {
            ...
            // CRITICAL: Create and initialize voice agent manager (only if feature is enabled)
            ...
            if (window.FEATURE_VOICE_AGENT) {
                ...
                // Feature disabled - set to null to prevent errors
                window.currentEditor.voiceAgent = null;
                logger.debug('DiagramSelector', 'Voice agent feature disabled, skipping initialization');
            }
