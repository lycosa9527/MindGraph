...
class MindMapOperations {
    ...
    saveNodeStyles(spec, nodeId, styles) {
        ...
        this.logger.debug('MindMapOperations', 'Saved node styles', {
            nodeId,
