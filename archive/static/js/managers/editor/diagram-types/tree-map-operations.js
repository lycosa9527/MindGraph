...
class TreeMapOperations {
    ...
    saveNodeStyles(spec, nodeId, styles) {
        ...
        this.logger.debug('TreeMapOperations', 'Saved node styles', {
            nodeId,
