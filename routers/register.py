...
_learning_space_mod = _try_import_module("routers.features.learning_space", "learning_space")
LEARNING_SPACE_MODULE = getattr(_learning_space_mod, "router", None) if _learning_space_mod else None
